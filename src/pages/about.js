...
<div>
            ...
            <div class="bg-appointment rounded">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 py-5">
                        <div class="rounded p-5 my-5" style={{ background: "rgba(255, 255, 255, 0.05)" }}>
    ...
    <div class="container-fluid bg-secondary text-white pt-5 px-sm-3 px-md-5" style={{marginTop: "90px"}}>
        <div class="row mt-5">
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-lg-center p-4"style={{ background: "rgba(255, 255, 255, 0.05)" }}>
        ...
        <div class="row p-4 mt-5 mx-0" style={{ background: "rgba(255, 255, 255, 0.05)" }}>
