    ...
    <div class="container-fluid p-0 mb-5 pb-5">
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style={{height: "100vh", minHeight: "400px"}}>
                    <img class="position-absolute w-100 h-100" src="img/carousel-1.jpg" style={{objectFit: "cover"}}/>
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style={{maxWidth: "900px"}}>
                            <h4 class="text-white text-uppercase mb-4" style={{letterSpacing: "3px"}}>Best Law Agency</h4>
                ...
                <div class="carousel-item position-relative" style={{height: "100vh", minHeight: "400px"}}>
                    <img class="position-absolute w-100 h-100" src="img/carousel-2.jpg" style={{objectFit: "cover"}}/>
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style={{maxWidth: "900px"}}>
                            <h4 class="text-white text-uppercase mb-4" style={{letterSpacing: "3px"}}>Results You Deserve</h4>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <h2 class="position-relative text-center bg-white text-primary rounded p-3 mt-4 mb-4 d-none d-lg-block" style={{width: "350px", marginLeft: "-205px"}}>25 Years Experience</h2>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-9 pt-5 pt-lg-0">
                    ...
                    <div class="owl-carousel service-carousel position-relative" style={{marginTop: "-100px", padding: "0 30px"}}>
            ...
            <div class="row">
                <div class="col-lg-6" style={{minHeight: "500px"}}>
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="img/feature.jpg" style={{objectFit: "cover"}}/>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="bg-primary rounded" style={{height: "200px"}}></div>
                    <div class="owl-carousel team-carousel position-relative" style={{marginTop: "-97px", padding: "0 30px"}}>
